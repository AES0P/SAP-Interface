 ...
 * 这里当然可以为每一个函数都注册同一个handle，但是后期不好维护，最好对不同的函数维护不同的handle
 */
@Slf4j
public class STFC_CONNECTIONHandler implements JCoServerFunctionHandler {
