package com.aesop.demo.rfcdiscover.config;
...
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                //swagger要扫描的包路径
                .apis(RequestHandlerSelectors.basePackage("com.aesop.demo.rfcdiscover.controller"))
...
//                .securitySchemes(security());// 如何保护我们的Api，有三种验证（ApiKey, BasicAuth, OAuth）
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .contact(new Contact("Swagger测试", "localhost：5001/swagger-ui.html", "github.com/AES0P"))//创建人
                .version("1.0.0")//版本号
                .build();
    }
